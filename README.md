...
|**LSTM**|**Num of Hidden Layers : 1**|**0.219**|**SGD**|
|LSTM|Num of Hidden Layers : 1|0.235|Adam|
...
- 이를 기관에서 활용하는 경우, 유가와 수출입량 및 물가 상승률 등을 복합적으로 고려하 특정 작물 모델링에 집중한다면 더욱 성능이 좋은 모델 수립이 가능할 것으로 보인다.
